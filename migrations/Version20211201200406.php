 ...
 */
final class Version20211201200406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE color color VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE comment ADD article_id INT NOT NULL, DROP datestamp');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD datestamp DATETIME NOT NULL, DROP article_id');
    }
}
